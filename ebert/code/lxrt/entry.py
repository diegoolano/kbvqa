...
class LXRTEncoder(nn.Module):
    def __init__(self, args, max_seq_length, use_lm=None, mode='x'):
        ...
        if args == []:
            # this is to allow loading of LXMERT as target in EBERT for mapping
            print("Load params for LXMERT/EBERT mapping from pickle file")
            args = pickle.load( open( "lxmert_args.pkl", "rb" ) )
