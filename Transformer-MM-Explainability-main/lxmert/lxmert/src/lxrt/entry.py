    ...
    for (i, sent) in enumerate(sents):
        ...
        if use_lm == "ebert":
            ...
            if len(cur_ents_sorted) == 11: 
                ...
                tokens_a, ents = return_okvqa_tokens_with_unks_and_ent_set(sent, cur_ents_sorted, tokenizer, debug=True)
            else:
                tokens_a, ents = return_tokens_with_unks_and_ent_set(sent, cur_ents_sorted, tokenizer, debug=True)
