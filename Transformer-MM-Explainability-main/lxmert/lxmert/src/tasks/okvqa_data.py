...
# The path to data and image features ( TODO: GET FASTCNN FEATURES for IMGFEAT  and put OKVQA questions/annotations in lxmert/data/okvqa/ )
    ...
    def __init__(self, splits: str, use_lm: None, ent_set: None, debug=True):
        ...
        if use_lm == "ebert":
            if ent_set == None:
                ...
                entity_spans_dict = json.load(open(abs_path + "data/okvqa/okvqa_ent_spans_sept08_cleaned_filtered.json")) #sept 8
