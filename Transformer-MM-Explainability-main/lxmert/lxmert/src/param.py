...
def parse_args():
    ...
    # from EBERT
    parser.add_argument("--split_num", default="0")      #D: "0" to "4" for current split
    parser.add_argument("--incl_para", action='store_const', default=False, const=True)     #D: include paraphrase questions
    parser.add_argument("--incl_caption", action='store_const', default=False, const=True)  #D: include caption in question
    parser.add_argument("--use_lm", default=None, type=str, help='For padding ebert or eae to LXMERT as the embedder/LM to use')     
    parser.add_argument("--max_len", default=20, type=int)
    parser.add_argument("--ent_set", default=None, type=str)
    parser.add_argument('--use_capt_sep', action='store_const', default=False, const=True, help='use [SEP] instead of concatenation for adding caption?')
    parser.add_argument("--pred_out", default="experiments/pred_out.json", type=str, help='Path/file where to store test prediction results')     

    parser.add_argument("--save_training", action='store_const', default=False, const=True)     #D: For knn LM experiment
    parser.add_argument('--k', type=int, default=10)
    parser.add_argument("--dataset_wise_norm", action='store_const', default=False, const=True) #D: For knn LM experiment
