...
# ADD use_lm
def get_data_tuple(splits: str, bs:int, shuffle=False, drop_last=False, incl_para=False, incl_caption=False, 
                   use_lm=None, ent_set=None, use_capt_sep= None, use_dpr = False) -> DataTuple:
    dset = KVQADataset(splits, incl_para, incl_caption, use_lm, ent_set, use_capt_sep, use_dpr)
...
class KVQA:
    def __init__(self):
        ...
        self.train_tuple = get_data_tuple(
            ...
            use_capt_sep = args.use_capt_sep, use_dpr = args.use_dpr
        )
        if args.valid != "":
    ...
    def predict(self, eval_tuple: DataTuple, dump=None):
        ...
        for i, (ques_id, feats, boxes, sent, ent_spans, target) in viter_wrapper(enumerate(vloader)):
            ...
            with torch.no_grad():
                ...
                for qid, l in zip(ques_id, label.cpu().numpy()):
                    ...
                    cur += 1
                    quesid2ans[qid] = ans   # FOR FUTURE STUFF, I SHOULD ADD MORE THAN JUST THE ANSWER ( top5 answers and probs, etc )
        ...
        if debug:
            ...
            print("In PREDICT() kvqa_data with Total:", cur, " with AnsNot Found:", notfound, " ( ",round(notfound/cur,4),"%)")
        return quesid2ans
    ...
    def evaluate(self, eval_tuple: DataTuple, dump=None):
        ...
        #print("Quesid2ans len found is", len(quesid2ans))
...
if __name__ == "__main__":
    ...
    if args.test is not None:
        ...
        if 'test' in args.test:
            ...
            batch_size = 950 if args.batch_size == 256 else args.batch_size  #256 is default if nothing is passed in
            test_tuple = get_data_tuple(args.test, bs=batch_size, shuffle=False, drop_last=False, incl_para = args.incl_para, incl_caption = args.incl_caption, use_lm = args.use_lm, ent_set=args.ent_set, use_capt_sep = args.use_capt_sep, use_dpr = args.use_dpr)
